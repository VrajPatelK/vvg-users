...
const SuccessAlertCard = (props) => {
  ...
  return (
    <div
      ...
      className="flex flex-col justify-center items-center p-4 mb-4 text-green-800 border border-green-300 rounded-lg bg-green-50 dark:bg-gray-800 dark:text-green-400 dark:border-green-800 mx-48"
      role="alert"
    >
      <div className="flex items-center">
        <svg
          className="flex-shrink-0 w-2 h-4 me-2"
          aria-hidden="true"
      ...
      <div className="mt-2 mb-4 text-sm capitalize">
        do you want send another message ?
      </div>
